...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= BASE_URL ?>/generate_laporan">
                    <i class="fas fa-fw fa-file-pdf "></i>
                    <span>Cetak Laporan</span></a>
            </li>

            <li class="nav-item">
                <a href="<?= BASE_URL ?>/dashboard/history" class="nav-link">
            ...
            <li class="nav-item">
                ...
                <div id="pengguna" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= BASE_URL ?>/dashboard/siswa">Siswa</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= BASE_URL ?>/dashboard/pembayaran">

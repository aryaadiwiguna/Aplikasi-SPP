                        ...
                        <tbody>
                            <?php foreach($data['siswa'] as $s ) : ?>
                                <tr>
                                    ...
                                    <td><?= $s['nominal'] ?></td>
                                    <td>
                                        <a href="<?= BASE_URL ?>/dashboard/editSiswa/<?= $s['id_siswa'] ?>" class="btn btn-warning">Edit</a>
                                        <form action="<?= BASE_URL ?>/dashboard/destroySiswa/<?= $s['id_pengguna'] ?>" class="d-inline" method="post">
